...
ngx_int_t ngx_mail_pop3_parse_command(ngx_mail_session_t *s) {
    ...
    ngx_str_t *arg;
    enum {
        sw_start = 0, sw_spaces_before_argument, sw_argument, sw_almost_done
    } state;
            ...
            case sw_argument:
                switch (ch) {
                    ...
                    case ' ':
                        ...
                        if (s->command == NGX_POP3_USER || s->command == NGX_POP3_PASS) {
                            break;
                        }
            ...
            case sw_command:
                if (ch == ' ' || ch == CR || ch == LF) {
                    ...
                    switch (p - c) {
                        ...
                        case 4:
                            if ((c[0] == 'N' || c[0] == 'n') && (c[1] == 'O' || c[1] == 'o') && (c[2] == 'O' || c[2] == 'o') &&
                                (c[3] == 'P' || c[3] == 'p')) {
                        ...
                        case 5:
                            if ((c[0] == 'L' || c[0] == 'l') && (c[1] == 'O' || c[1] == 'o') && (c[2] == 'G' || c[2] == 'g') &&
                                (c[3] == 'I' || c[3] == 'i') && (c[4] == 'N' || c[4] == 'n')) {
                        ...
                        case 6:
                            if ((c[0] == 'L' || c[0] == 'l') && (c[1] == 'O' || c[1] == 'o') && (c[2] == 'G' || c[2] == 'g') &&
                                (c[3] == 'O' || c[3] == 'o') && (c[4] == 'U' || c[4] == 'u') && (c[5] == 'T' || c[5] == 't')) {
                        ...
                        case 12:
                            if ((c[0] == 'A' || c[0] == 'a') && (c[1] == 'U' || c[1] == 'u') && (c[2] == 'T' || c[2] == 't') &&
                                (c[3] == 'H' || c[3] == 'h') && (c[4] == 'E' || c[4] == 'e') && (c[5] == 'N' || c[5] == 'n') &&
                                (c[6] == 'T' || c[6] == 't') && (c[7] == 'I' || c[7] == 'i') && (c[8] == 'C' || c[8] == 'c') &&
                                (c[9] == 'A' || c[9] == 'a') && (c[10] == 'T' || c[10] == 't') && (c[11] == 'E' || c[11] == 'e')) {
...
ngx_int_t ngx_mail_smtp_parse_command(ngx_mail_session_t *s) {
    ...
    ngx_str_t *arg;
    enum {
        sw_start = 0, sw_command, sw_invalid, sw_spaces_before_argument, sw_argument, sw_almost_done
    } state;
