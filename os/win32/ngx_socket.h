...
IN DWORD
dwRemoteAddressLength,
OUT struct sockaddr **LocalSockaddr, OUT
LPINT LocalSockaddrLength, OUT
struct sockaddr **RemoteSockaddr, OUT
...
typedef struct _TRANSMIT_FILE_BUFFERS {
    ...
    LPVOID Tail;
    DWORD TailLength;
} TRANSMIT_FILE_BUFFERS, *PTRANSMIT_FILE_BUFFERS, FAR
*
...
} TRANSMIT_PACKETS_ELEMENT, *PTRANSMIT_PACKETS_ELEMENT, FAR
*
...
typedef BOOL (PASCAL
FAR *LPFN_TRANSMITPACKETS
) (
SOCKET hSocket, TRANSMIT_PACKETS_ELEMENT
*lpPacketArray,
DWORD nElementCount, DWORD
nSendSize,
LPOVERLAPPED lpOverlapped, DWORD
dwFlags
);
