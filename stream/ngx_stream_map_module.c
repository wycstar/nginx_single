...
static ngx_command_t ngx_stream_map_commands[] = {
        ...
        {ngx_string("map"), NGX_STREAM_MAIN_CONF | NGX_CONF_BLOCK | NGX_CONF_TAKE2, ngx_stream_map_block, NGX_STREAM_MAIN_CONF_OFFSET, 0,
         NULL},

        {ngx_string("map_hash_max_size"), NGX_STREAM_MAIN_CONF | NGX_CONF_TAKE1, ngx_conf_set_num_slot, NGX_STREAM_MAIN_CONF_OFFSET,
         offsetof(ngx_stream_map_conf_t, hash_max_size), NULL},

        {ngx_string("map_hash_bucket_size"), NGX_STREAM_MAIN_CONF | NGX_CONF_TAKE1, ngx_conf_set_num_slot, NGX_STREAM_MAIN_CONF_OFFSET,
         offsetof(ngx_stream_map_conf_t, hash_bucket_size), NULL},

        ngx_null_command};


static ngx_stream_module_t ngx_stream_map_module_ctx = {NULL,                                  /* preconfiguration */
...
ngx_module_t ngx_stream_map_module = {NGX_MODULE_V1, &ngx_stream_map_module_ctx,            /* module context */
...
static ngx_int_t ngx_stream_map_variable(ngx_stream_session_t *s, ngx_stream_variable_value_t *v, uintptr_t data) {
    ...
    ngx_log_debug0(NGX_LOG_DEBUG_STREAM, s->connection->log, 0, "stream map started");
    ...
    ngx_log_debug2(NGX_LOG_DEBUG_STREAM, s->connection->log, 0, "stream map: \"%V\" \"%v\"", &val, v);
