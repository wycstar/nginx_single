...
static ngx_command_t ngx_stream_commands[] = {
        ...
        {ngx_string("stream"), NGX_MAIN_CONF | NGX_CONF_BLOCK | NGX_CONF_NOARGS, ngx_stream_block, 0, 0, NULL},
...
ngx_module_t ngx_stream_module = {NGX_MODULE_V1, &ngx_stream_module_ctx,                /* module context */
