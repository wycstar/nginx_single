...
static ngx_int_t ngx_stream_realip_remote_addr_variable(ngx_stream_session_t *s, ngx_stream_variable_value_t *v, uintptr_t data);
...
static ngx_command_t ngx_stream_realip_commands[] = {
        ...
        {ngx_string("set_real_ip_from"), NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1, ngx_stream_realip_from,
         NGX_STREAM_SRV_CONF_OFFSET, 0, NULL},

        ngx_null_command};


static ngx_stream_module_t ngx_stream_realip_module_ctx = {ngx_stream_realip_add_variables,       /* preconfiguration */
...
ngx_module_t ngx_stream_realip_module = {NGX_MODULE_V1, &ngx_stream_realip_module_ctx,         /* module context */
...
static ngx_stream_variable_t ngx_stream_realip_vars[] = {
        ...
        {ngx_string("realip_remote_addr"), NULL, ngx_stream_realip_remote_addr_variable, 0, 0, 0},

        {ngx_string("realip_remote_port"), NULL, ngx_stream_realip_remote_port_variable, 0, 0, 0},
