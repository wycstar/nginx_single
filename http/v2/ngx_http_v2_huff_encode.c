...
static ngx_http_v2_huff_encode_code_t ngx_http_v2_huff_encode_table[256] = {{0x00001ff8, 13},
                                                                            {0x007fffd8, 23},
                                                                            {0x0fffffe2, 28},
                                                                            {0x0fffffe3, 28},
                                                                            {0x0fffffe4, 28},
...
static ngx_http_v2_huff_encode_code_t ngx_http_v2_huff_encode_table_lc[256] = {{0x00001ff8, 13},
                                                                               {0x007fffd8, 23},
                                                                               {0x0fffffe2, 28},
                                                                               {0x0fffffe3, 28},
                                                                               {0x0fffffe4, 28},
...
size_t ngx_http_v2_huff_encode(u_char *src, size_t len, u_char *dst, ngx_uint_t lower) {
    ...
    table = lower ? ngx_http_v2_huff_encode_table_lc : ngx_http_v2_huff_encode_table;
    hlen = 0;
    buf = 0;
    pending = 0;
