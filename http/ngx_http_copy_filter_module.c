...
static ngx_command_t ngx_http_copy_filter_commands[] = {
        ...
        {ngx_string("output_buffers"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE2, ngx_conf_set_bufs_slot,
         NGX_HTTP_LOC_CONF_OFFSET, offsetof(ngx_http_copy_filter_conf_t, bufs), NULL},

        ngx_null_command};


static ngx_http_module_t ngx_http_copy_filter_module_ctx = {NULL,                                  /* preconfiguration */
...
ngx_module_t ngx_http_copy_filter_module = {NGX_MODULE_V1, &ngx_http_copy_filter_module_ctx,      /* module context */
