...
static ngx_conf_enum_t ngx_http_gzip_static[] = {{ngx_string("off"),    NGX_HTTP_GZIP_STATIC_OFF},
...
static ngx_command_t ngx_http_gzip_static_commands[] = {
        ...
        {ngx_string("gzip_static"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1, ngx_conf_set_enum_slot,
         NGX_HTTP_LOC_CONF_OFFSET, offsetof(ngx_http_gzip_static_conf_t, enable), &ngx_http_gzip_static},

        ngx_null_command};


static ngx_http_module_t ngx_http_gzip_static_module_ctx = {NULL,                                  /* preconfiguration */
...
ngx_module_t ngx_http_gzip_static_module = {NGX_MODULE_V1, &ngx_http_gzip_static_module_ctx,      /* module context */
...
static char *ngx_http_gzip_static_merge_conf(ngx_conf_t *cf, void *parent, void *child) {
    ...
    ngx_conf_merge_uint_value(conf->enable, prev->enable, NGX_HTTP_GZIP_STATIC_OFF);
