...
static ngx_command_t ngx_http_upstream_least_conn_commands[] = {
        ...
        {ngx_string("least_conn"), NGX_HTTP_UPS_CONF | NGX_CONF_NOARGS, ngx_http_upstream_least_conn, 0, 0, NULL},

        ngx_null_command};


static ngx_http_module_t ngx_http_upstream_least_conn_module_ctx = {NULL,                                  /* preconfiguration */
...
ngx_module_t ngx_http_upstream_least_conn_module = {NGX_MODULE_V1, &ngx_http_upstream_least_conn_module_ctx, /* module context */
...
static ngx_int_t ngx_http_upstream_get_least_conn_peer(ngx_peer_connection_t *pc, void *data) {
    ...
    if (best == NULL) {
        ngx_log_debug0(NGX_LOG_DEBUG_HTTP, pc->log, 0, "get least conn peer, no peer found");
