...
static ngx_command_t ngx_http_rewrite_commands[] = {
        ...
        {ngx_string("if"), NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_BLOCK | NGX_CONF_1MORE, ngx_http_rewrite_if,
...
static ngx_http_module_t ngx_http_rewrite_module_ctx = {NULL,                                  /* preconfiguration */
...
ngx_module_t ngx_http_rewrite_module = {NGX_MODULE_V1, &ngx_http_rewrite_module_ctx,          /* module context */
...
static char *ngx_http_rewrite_return(ngx_conf_t *cf, ngx_command_t *cmd, void *conf) {
    ...
    if (ret->status == (uintptr_t) NGX_ERROR) {
        ...
        if (cf->args->nelts == 2 &&
            (ngx_strncmp(p, "http://", sizeof("http://") - 1) == 0 || ngx_strncmp(p, "https://", sizeof("https://") - 1) == 0 ||
