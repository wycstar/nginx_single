...
static ngx_command_t ngx_http_mirror_commands[] = {
        ...
        {ngx_string("mirror"), NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1, ngx_http_mirror,
...
static ngx_http_module_t ngx_http_mirror_module_ctx = {NULL,                                  /* preconfiguration */
...
ngx_module_t ngx_http_mirror_module = {NGX_MODULE_V1, &ngx_http_mirror_module_ctx,           /* module context */
